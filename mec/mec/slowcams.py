...
class SlowCameras():
    ...
    def stage(self):
        ...
        for (phy,iCamera) in lAllocatedFli:
            ...
            configFli['exposureEventCode'] = self._seq.EC['slowcam']

            print("  W %d H %d speed %d code %d" % (width, height, speed, configFli['exposureEventCode']))

            configFli['numDelayShots'] = self.laser_config['during']
